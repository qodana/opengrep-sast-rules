...
func foo3() {
	// This randomnly started failing. We don't know the correct fix yet. 
	// Requested help from semgrep team. Relevant thread - https://gitlab.com/gitlab-org/security-products/sast-rules/-/merge_requests/702#note_2630077558
	// todoruleid:go_file-permissions_rule-fileperm
