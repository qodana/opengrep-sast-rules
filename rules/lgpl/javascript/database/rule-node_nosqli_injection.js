...
app.post('/login', function (req, res) {
    // ruleid:rules_lgpl_javascript_database_rule-node-nosqli-injection
    User.findOne({ 'email': String(req.body.email), 'password': req.body.password }, function (err, data) {
        if (err) {
            res.send(err);
        } else if (data) {
            res.send('User Login Successful');
...
app.post('/login', function (req, res) {
    // ruleid:rules_lgpl_javascript_database_rule-node-nosqli-injection
    User.findOne({ 'email': req.body.email, 'password': String(req.body.password) }, function (err, data) {
        if (err) {
            res.send(err);
        } else if (data) {
            res.send('User Login Successful');
    ...
    app.post('/login', function (req, res) {
    // ok:rules_lgpl_javascript_database_rule-node-nosqli-injection
    User.findOne({ 'email': String(req.body.email), 'password': String(req.body.password) }, function (err, data) {
        if (err) {
            res.send(err);
        } else if (data) {
            res.send('User Login Successful');
    ...
    app.post('/login', function (req, res) {
    // ok:rules_lgpl_javascript_database_rule-node-nosqli-injection
    User.findOne({ 'email': String(req.body.email) }, function (err, data) {
        if (err) {
            res.send(err);
        } else if (data) {
            res.send('User Login Successful');
